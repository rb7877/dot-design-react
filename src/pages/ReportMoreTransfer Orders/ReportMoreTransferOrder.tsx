...
import cx from "./ReportMoreTransferOrder.module.scss";
...
import Modals from "../../components/Modals/ReportMoreTransferOrderM";
                  ...
                  <ul className={`${table.dropDownUl} ${cx.dropScroll}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        ...
                        <label className={`${table.checkbox}`}>
                            <input type="checkbox" />
                            <span className={`${table.checkmark}`}></span> Destination
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Submitted By 
                      </label>
                    </li>
...
export default function ReportMoreTransferOrder() {
