...
import cx from "./ReportMoreCostAdjustmentHistory.module.scss";
...
import Modals from "../../components/Modals/ReportMoreCostAdjustmentHistoryM";
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        ...
        <TableContainer>
          <div className="p-5">
             <span className="d-block text-center "> Cost Adjustment History report shows all cost adjustment transactions that were applied on your inventory items. Adjust the date & filters in the report to get more specific results. </span>
          </div>
        </TableContainer>
      </Paper>
    </Box>
...
export default function ReportMoreCostAdjustmentHistory() {
