...
import cx from "./Reportsinventorylevels.module.scss";
...
import Modals from "../../components/Modals/ReportsInventoryLevelsM";
...
const rows = [
  {
    ...
    storageunit: "800",
    quantity: "-989,990",
    costperunit: "SAR 1,000",
    totalcost: "SAR 11,016.67",
  },
  {
    name: "mistake ice cream",
    sku: "sk-00552",
          ...
          <ul className={`${table.rightActionIcons}`}>
            <li>
              <button
                ...
                onClick={() => {
                  handleShow("inventory filter", true);
                  console.log("check");
                }}
              >
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell  align="left">{row.costperunit}</TableCell>
...
export default function Reportsinventorylevels() {
