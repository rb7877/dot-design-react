...
import cx from "./ReportMoreTips.module.scss";
...
import Modals from "../../components/Modals/ReportMoreTipsM";
          ...
          <ul className={`${table.rightActionIcons}`}>
            <li>
              <button
                ...
                onClick={() => {
                  handleShow("report more tips filter", true);
                  console.log("check");
                }}
              >
  ...
  return (
    <Box sx={{ width: "100%" }}>
      <Paper sx={{ width: "100%", mb: 2 }}>
        ...
        <TableContainer>
          <div className="m-5">
             <span className="d-block text-center  "> Tips report gives you insights about the tips paid by your customers. Adjust the date & filters in the report to get more specific results.</span>
          </div>
        </TableContainer>
      </Paper>
    </Box>
...
export default function ReportMoreTips() {
