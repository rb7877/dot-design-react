                  ...
                  return (
                    ...
                    >
                      ...
                      <div className={`${cx.tableNameDetail}`}>
                        <span>Mohammed Salah</span>
                        <span> mohammed@bcs-sa.net</span>
                      </div>
                      </TableCell>


                      <TableCell onClick={() => { redirectToAnotherPage(row?.consoleaccess) }} align="left">
                        <span className={`${st.statusBtn}`} style={{ backgroundColor:'#EB5757' }}></span>  
                      </TableCell>

                      <TableCell onClick={() => { redirectToAnotherPage(row?.appaccess) }} align="left">
                      <span className={`${st.statusBtn}`} style={{ backgroundColor:'#EB5757' }}></span>  
                      </TableCell>

                      <TableCell onClick={() => { redirectToAnotherPage(row.role) }} align="left">
                        <>
                          <div className={`${cx.tableButton}`}>
                            <button> owner</button>
                            <button> كاشير 1</button>
                            <button> 1ويتر</button>
                          </div>
                        </>    
                      </TableCell>
