...
import cx from "./Ordertransaction.module.scss";
      ...
      >
        <div className={`${table.mainTitleRow}`}>
          <ul className={`${table.filterList}`}>
            ...
            <li>
              <button className={`btn ${table.filterBtn}`}>Return</button>{" "}
            </li>
            <li>
              <button className={`btn ${table.filterBtn}`}>Waste</button>{" "}
            </li>
          </ul>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row.branch) }} align="left">{row.branch}</TableCell>
                      <TableCell onClick={() => { redirectToAnotherPage(row.orderreference) }} align="left">{row.orderreference}</TableCell>
