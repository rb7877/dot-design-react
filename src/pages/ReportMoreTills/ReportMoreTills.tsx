...
import cx from "./ReportMoreTills.module.scss";
...
import Modals from "../../components/Modals/ReportMoreTillsM";
...
const rows = [
  ...
  branchreference:"B01",
  user:"wh1",
  openedat:"September 05, 11:45am", 
  openingamount: "SAR 0",
  netcashpayment: "SAR 0",
  },
                ...
                <Dropdown.Menu>
                  <ul className={`${table.dropDownUl} ${cx.dropScroll}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> User
                      </label>
                    </li>
                        <li>
                        <label className={`${table.checkbox}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Opening Amount
                      </label>
                    </li>
                    <li>
                      <label className={`${table.checkbox}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Total Pay-Outs
                      </label>
                    </li>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.openingamount}</TableCell>
                      <TableCell align="left">{row.netcashpayment}</TableCell>
...
export default function ReportMoreTills() {
