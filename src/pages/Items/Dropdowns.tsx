...
export const Export = () => {
  return (
    ...
    <Dropdown>
      ...
      <Dropdown.Menu>
        <ul>
          <li><NavLink to="#">Import Items</NavLink></li>
          <li><NavLink to="#">Import Items Ingredients</NavLink></li>
          <li><NavLink to="#">Export Items</NavLink></li>
          <li><NavLink to="#">Export Items Ingredients</NavLink></li>
        </ul>
      </Dropdown.Menu>
    </Dropdown>
  );
