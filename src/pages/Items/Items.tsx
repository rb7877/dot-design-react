                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row.name) }} align="left">{row.sku}</TableCell>
                      <TableCell onClick={() => { redirectToAnotherPage(row.name) }} align="left">{row.category}</TableCell>
                    </TableRow>
                  );
                })}
              {emptyRows > 0 && (
