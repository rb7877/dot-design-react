                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={openModalPoupOnTableCell} align="left">{row.options}</TableCell>
                      <TableCell onClick={openModalPoupOnTableCell} align="left">{row.linkedproducts}</TableCell>
