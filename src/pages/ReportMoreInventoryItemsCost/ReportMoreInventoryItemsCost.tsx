...
import cx from "./ReportMoreInventoryItemsCost.module.scss";
...
import Modals from "../../components/Modals/ReportMoreInventoryItemsCostM";
              ...
              {stableSort(rows, getComparator(order, orderBy)).map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left"> {row.costingmethod} </TableCell>
...
export default function ReportMoreInventoryItemsCost() {
