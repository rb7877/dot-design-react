                ...
                <Row>
                  <Col md={12} lg={12}>
                    <Form.Group className={`${cx.formField}`}>
                      ...
                      <Form.Control type="text" placeholder="end year promo" />
                    </Form.Group>
                  </Col>
                  ...
                  <Col md={12} lg={12}>
                    <Form.Group className={`${cx.formField}`}>
                      ...
                      <Form.Control type="text"  placeholder="2022-12-01"/>
                    </Form.Group>
                  </Col>
                  <Col md={12} lg={12}>
                    <Form.Group className={`${cx.formField}`}>
                      ...
                      <Form.Control type="text" placeholder="2022-12-30" />
                    </Form.Group>
                  </Col>
                  <Col md={12} lg={12}>
                    <Form.Group className={`${cx.formField}`}>
