                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row?.reference) }} align="left">
                        {row.reference} 
                      </TableCell>

                      <TableCell onClick={() => { redirectToAnotherPage(row?.status) }} align="left">
                      <>
                          <div >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row?.type) }} align="left">
                      {row.type}
                      </TableCell>

                      <TableCell onClick={() => { redirectToAnotherPage(row.branch) }} align="left">
                          {row.branch}
                      </TableCell>
                    </TableRow>
                  );
