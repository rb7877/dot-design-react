...
import cx from "./Quantityadjustment.module.scss";
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row.reason) }} align="left">{row.reason}</TableCell>
          ...
          <div className={`${st.pageTitleRow}`}>
            ...
            <div className={`${st.rowTitleRight}`}>
              ...
              <button className={`btn ${st.themeBtn}`}
                onClick={() => {
                  handleShow("new quantity adjustment", true);
                }}
              >
