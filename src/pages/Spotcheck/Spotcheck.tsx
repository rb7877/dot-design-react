...
import cx from "./Spotcheck.module.scss";
                  ...
                  return (
                    ...
                    >
                      <TableCell
                        component="th"
                        id={labelId}
                        scope="row"  onClick={() => { redirectToAnotherPage(row.reference) }}
                      >
                        {row.reference}
                      </TableCell>
