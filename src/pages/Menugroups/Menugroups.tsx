...
import cx from "./Menugroups.module.scss";
...
const rows = [
  {
    name: "ايسكريم ليمون - Lemon Ice Cream",
    created: "April 11, 09:53am",
    primage:"-",
  },
  {
    name: "ايسكريم ليمون - Lemon Ice Cream",
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row.created) }} align="left">
                        <>
