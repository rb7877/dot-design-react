...
import cx from "./ReportMoreBusinessDays.module.scss";
...
import Modals from "../../components/Modals/ReportMoreBusinessDaysM";
...
const rows = [
  {
    ...
    openedat: "	September 18, 11:38am",
    closedat: "September 19, 11:55am",
    branch: "Alhsaa Branch B01",
    branchlocalized: "فرع الاحساء",
    branchreference: "B01",
  },
  {
    businessdate: "2022-09-01",
          ...
          <ul className={`${table.rightActionIcons}`}>
            <li>
              <button
                ...
                onClick={() => {
                  handleShow("report more business days filter", true);
                  console.log("check");
                }}
              >
                  ...
                  <ul className={`${table.dropDownUl} ${cx.dropScroll}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox} ${table.disabled}`}>
                        ...
                        <span className={`${table.checkmark}`}></span> Business Date 
                      </label>
                    </li>
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" checked />
                        <span className={`${table.checkmark}`}></span> Opened At
                      </label>
                    </li>
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Closed At
                      </label>
                    </li>
                    <li>
                      <label className={`${table.checkbox}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Branch Localized
                      </label>
                    </li>
                    <li>
                      <label className={`${table.checkbox}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Closed By
                      </label>
                    </li>
...
function EnhancedTable() {
  ...
  const [orderBy, setOrderBy] = React.useState<keyof Data>("businessdate");
  ...
  const handleSelectAllClick = (event: React.ChangeEvent<HTMLInputElement>) => {
    if (event.target.checked) {
      const newSelected = rows.map((n) => n.businessdate);
          ...
          >
            ...
            <TableBody>
              ...
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected(row.businessdate);
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.openedat}</TableCell>
                      <TableCell align="left">{row.closedat}</TableCell>
                      <TableCell align="left">{row.branch}</TableCell>
                      <TableCell align="left">{row.branchlocalized}</TableCell>
...
export default function ReportMoreBusinessDays() {
