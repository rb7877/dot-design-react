...
import cx from "./ReportMorePurchasing.module.scss";
...
import Modals from "../../components/Modals/ReportMorePurchasingM";

import { MdArrowBackIos, MdDeleteOutline } from "react-icons/md";

import { ActionDropdown, Export ,Groupname} from "./Dropdowns";
...
const rows = [
  ...
  storageunit: "Kg",
  purchasequantity:"1",
  purchasecost: "SAR 1,000",
  returnedquantity: "0",
  returnedcost: "SAR 1,000,"
  },
                ...
                <Dropdown.Menu>
                  <ul className={`${table.dropDownUl} ${cx.dropScroll}`}>
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Purchase Cost
                      </label>
                    </li>
                        <li>
                        <label className={`${table.checkbox}`}>
                            <input type="checkbox" />
                            <span className={`${table.checkmark}`}></span> Returned Quantity
                    ...
                    <li>
                      <label className={`${table.checkbox}`}>
                        <input type="checkbox" />
                        <span className={`${table.checkmark}`}></span> Returned Cost
                      </label>
                    </li>
                    <li>
                      <label className={`${table.checkbox}`}>
                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell align="left">{row.purchasequantity}</TableCell>
                      <TableCell align="left">{row.purchasecost}</TableCell>
                      <TableCell align="left">{row.returnedquantity}</TableCell>
                      <TableCell align="left">{row.returnedcost}</TableCell>
...
export default function ReportMorePurchasing() {
