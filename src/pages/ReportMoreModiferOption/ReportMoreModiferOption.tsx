...
import cx from "./ReportMoreModiferOption.module.scss";
...
import Modals from "../../components/Modals/ReportMoreModiferOptionM";
...
export default function ReportMoreModiferOption() {
