                ...
                .map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell onClick={() => { redirectToAnotherPage(row?.code) }} align="left">
                        {row.code}
                      </TableCell>

                      <TableCell onClick={() => { redirectToAnotherPage(row?.discount) }} align="left">
                      {row.discount}
                      </TableCell>

                      <TableCell onClick={() => { redirectToAnotherPage(row.maxusage) }} align="left">
                        {row.maxusage}
                      </TableCell>
