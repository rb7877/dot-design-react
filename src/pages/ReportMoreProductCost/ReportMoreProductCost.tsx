...
import cx from "./ReportMoreProductCost.module.scss";
...
import Modals from "../../components/Modals/ReportMoreProductCostM";
...
export default function ReportMoreProductCost() {
