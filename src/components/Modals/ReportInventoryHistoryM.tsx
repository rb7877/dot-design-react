...
import { costanalysisfilter, filtertagoptions, filterordertags, filterinventory,transactiontype, customertimezone, itemoption, ingredientsoptions ,filteritemstag  ,lowlevelfilter ,costingmethodfilter} from '../../constants/dropdownconstants'
...
const Modals = (props: any) => {
 ...
 {/* ############################################################
 ######################## report Inventory History MODALS ########################### */}

      {
        props.modalName === 'report Inventory History filter' &&
            ...
            <Row>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  ...
                  <FilterDropdown options={transactiontype} />
                </Form.Group>
              </Col>  
            </Row>
          </Modal.Body>
      ...
      {/* END report Inventory History Filter */}
