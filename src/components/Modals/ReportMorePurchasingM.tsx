            ...
            <Row>
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label className="d-block">Branches
                  <NavLink
              ...
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label className="d-block"> Categories
                 </Form.Label>
                  <FilterDropdown options={reportsordertags} />
                </Form.Group>
              </Col>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label className="d-block">items  <NavLink
                      className={`${cx.rightLabel}`}
                      to="#"
                      onClick={() => {
                        setinventoryItems(true);
                  ...
                  <FilterDropdown options={ warehousefilter } />
                </Form.Group>
              </Col>
              <Col md={12} lg={12}>
                <Form.Group className={`${cx.formField}`}>
                  <Form.Label className="d-block">Suppliers</Form.Label>
                  <FilterDropdown options={ warehousefilter } />
                </Form.Group>
              </Col>
            </Row>
