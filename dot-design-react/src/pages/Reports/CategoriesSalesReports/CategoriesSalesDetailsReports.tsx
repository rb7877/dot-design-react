...
export default function CategoriesSalesDetailsReports() {
          ...
          <Card.Title>
            <Row className={`align-items-center ${style.rowTitle}`}>
              <Col className={`col-2 ${cx.backBtn}`} lg={2}>
                <NavLink to="/reports/category-sales-report" className="btn">Back</NavLink>
              </Col> 
              <Col className={`col-10 text-center ${style.rowTitleLeft}`} lg={8}>
                <h5>Categories Sales Detail Rerports #29</h5>
              </Col>
            </Row>
          </Card.Title>
          <Card.Body>
